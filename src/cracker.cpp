...
*/
void help() {
    std::cout << "Below you can find proper usage of this paswword cracking program as well as additional options and features.\n" << std::endl;
...
*/
void options() {
    std::cout << "Currently available options:" << std::endl;
    std::cout << std::setw(10) << "" << "--help: Gives a comprehensive overview of the usage and features of this password cracker." << std::endl;
    std::cout << std::setw(10) << "" << "--options: Lists all available options that can be used when running this password cracker." << std::endl;
}
...
/*
* Function to hash password with salt appended using SHA-256 with OpenSSL
*/
